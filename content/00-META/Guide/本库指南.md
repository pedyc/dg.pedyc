...
| 40-RESOURCES | 整合笔记 | `concept`, `moc`, `sop`, `question`, `term`, `comparison`, `record`, `roadmap`, `person` |
| 50-ARCHIVE | 归档内容 | - |
...
| 层级 | 位置 | 说明 |
|------|------|------|
| 原子笔记层 | `30-Zettelkasten/` | 已内化的洞见，source of truth |
