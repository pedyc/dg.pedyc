...
**最后更新：2026-07-21** — 补充 UI本质上是状态的函数 atomic 笔记
...
- [[前端开发]] — 前端开发顶层领域（aliases: A-前端）

### 设计

- [[设计]] — 设计知识体系（aliases: A-设计）
...
- [[为什么更倾向函数组件|Q-为什么更倾向函数组件]] — 分析 React 社区从 Class 组件转向函数组件 + Hooks 的核心原因
