...
**最后更新：2026-07-28** — 设计模式 concept → term 重分类
...
- [[软件工程]] — 软件工程知识体系的总入口，涵盖项目结构、架构设计、工程化工具链等领域
...
- [[设计模式]] — 设计模式是在软件设计中解决常见问题的可重用解决方案
- [[类比思维]] — 类比推理、隐喻理解
- [[收敛思维]] — 收敛思维、聚合分析
...
*Wiki Index 最后更新：2026-07-27 by LLM sync + inbox sync*
