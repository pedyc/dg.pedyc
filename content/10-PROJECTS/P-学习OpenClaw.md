...
- [ ] 创建 Telegram 机器人：通过 [@BotFather](https://t.me/BotFather) 获取 Token
- [ ] 在 OpenClaw Web 控制台配置 Telegram 频道：
	- [ ] 填入 Bot Token
	- [ ] 设置频道策略（建议先用 `open` 模式测试）
	- [ ] 配置允许的用户/群组
- [ ] 测试基础连通性：发送 `/start` 命令，观察响应
