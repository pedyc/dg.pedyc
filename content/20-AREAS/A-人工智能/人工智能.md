...
- **里程碑**：
	- [ ] KR1：理解 LLM 能力边界 — 知道 AI 能做什么、擅长什么、局限在哪
	- [ ] KR2：掌握提示词工程 — 能针对具体前端场景写出稳定、可复用的 Prompt
	- [ ] KR3：集成 AI 到项目 — 在实际项目中对接 AI API（Claude/OpenAI），实现功能增强
	- [ ] KR4：构建 AI 辅助工作流 — 用 Claude Code / AI 工具提升日常开发效率（组件生成、代码审查、文档撰写）
