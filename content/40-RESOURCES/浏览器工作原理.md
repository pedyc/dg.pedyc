---
title: 浏览器工作原理
aliases: ["C-浏览器工作原理", Browser Internals, 浏览器运行机制, 关键渲染路径]
tags: [领域/浏览器, 核心概念, 面试/高频]
date-created: 2025-12-17
date-modified: 2026-05-22
status: 🟢 活跃
content-type: concept
related: ["[[浏览器渲染流程]]", "[[事件循环]]"]
---
...
- [x] **面试题**：从输入 URL 到页面展示发生了什么？(网络阶段 + 渲染阶段) ✅ 2025-12-26
	- [x] 👉[[从输入URL到页面展示发生了什么|Q-从输入URL到页面展示发生了什么]] ✅ 2026-05-22
- [x] **面试题**：为什么 `<script>` 标签通常放在 `<body>` 底部？(防止阻塞 DOM 构建) ✅ 2025-12-26
- [x] **面试题**：`async` 和 `defer` 脚本的区别是什么？ ✅ 2026-05-22
	- [x] 👉[[VS-async vs defer]] ✅ 2026-05-22
- [x] **进阶**：了解 **Layer 模型**，什么样的 CSS 属性会创建新的合成层 (Compositing Layer)？(如 `will-change`, `video`, `z-index` 高级应用)。 ✅ 2026-05-22
