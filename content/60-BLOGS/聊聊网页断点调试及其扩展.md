...
description: "作者：Rabbitzzc 抖音小程序开发者工具是面向字节系小程序开发者推出的桌面端集成开发环境，支持小程序开发、调试、预览、上传等基本功能，旨在帮助开发者更高效地开发小程序，我也是负责本地开发能力的建设。因为…"
tags: ["clippings"]
date-created: 2026-05-26
date-modified: 2026-05-26
created: 2026-05-26
published:
source: "https://zhuanlan.zhihu.com/p/667204171"
---
...
[抖音小程序开发者工具](https://link.zhihu.com/?target=https%3A//developer.open-douyin.com/docs/resource/zh-CN/mini-app/develop/developer-instrument/overview) 是面向字节系小程序开发者推出的桌面端集成开发环境，支持小程序开发、调试、预览、上传等基本功能，旨在帮助开发者更高效地开发小程序，我也是负责本地开发能力的建设。
...
![[../../_resources/聊聊网页断点调试及其扩展/e01204d3f8c43b829fc4bab6cd3ff798_MD5.webp]]

2. `debugger` ，在代码中输入 `debugger` 关键字，然后在浏览器中进行断点调试，或者在浏览器中找到源码，然后进行断点调试。
![[../../_resources/聊聊网页断点调试及其扩展/7e8bed1ba27f87614536e417f992cf97_MD5.webp]]

3. vscode 自带的 web 调试能力。
![[../../_resources/聊聊网页断点调试及其扩展/46700d5a509cfcef450969d744f45be4_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/df96942b7b985aa43d9f935f8e421bcf_MD5.webp]]

上图为 [CDP 的官网](https://link.zhihu.com/?target=https%3A//chromedevtools.github.io/devtools-protocol) ，可以看到，CDP 包括很多 Domains，常见的 CDP 信息包括：
...
![[../../_resources/聊聊网页断点调试及其扩展/7cd7717c22db652acdc117fce40c8fb9_MD5.webp]]
...
在浏览器中，网页的调试能力是由 Devtools 提供的。Devtools 与网页之间的通信利用的是 [Websocket](https://zhida.zhihu.com/search?content_id=236397384&content_type=Article&match_order=1&q=Websocket&zhida_source=entity) ，而通信协议则是 CDP。
...
![[../../_resources/聊聊网页断点调试及其扩展/094ce84fbff6d7947a2480f0613b0fa5_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/af62e19d7f5e19ba30072ce7ccd98ac7_MD5.webp]]

![[../../_resources/聊聊网页断点调试及其扩展/3033c715026527184447667335c0eba8_MD5.webp]]

整体流程如下图：

![[../../_resources/聊聊网页断点调试及其扩展/e6f653fa1f08cb608385be570a9f3bdb_MD5.jpg]]

### 移除断点

除了在 sources 面板增加断点，还可以取消断点。取消断点的 CDP 非常简单， Devtools 会给 Web Page 发送一个 Debugger.removeBreakpoint 来移除断点。

![[../../_resources/聊聊网页断点调试及其扩展/f3a9fe36459d649726d06a988775acf5_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/32ff60c0f60dc3541e6baf6ab408d023_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/1c1963d5c9f14c6c6043ad181739be31_MD5.webp]]

> 具体信息没有对应看

![[../../_resources/聊聊网页断点调试及其扩展/500716e93ed13ea497551731e5a30765_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/3d1028c85b6463960a01e5c04e025d03_MD5.webp]]

除了上面两个按钮，还有几个调试按钮，如下图绿色区域内：

![[../../_resources/聊聊网页断点调试及其扩展/21cc2b10b05a7be51fa55040008db7cf_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/86ace6f872d36aa5756600e4f763b8ce_MD5.webp]]

点击 "Step out of current function"，Devtools 会发送 `Debugger.stepOut` 消息，并收到 `Debugger.resumed` 和 `Debugger.paused` 消息，跳出该函数。

![[../../_resources/聊聊网页断点调试及其扩展/3a9b3e62fb6930727a231f9159e411f8_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/3547e216217595c4262f6061eb4eeac6_MD5.webp]]
...
首先，Devtools 的源码就是 Front-End Devtools，UI 上的逻辑这里就不多分析。 [关于页面的调试通信逻辑在 DebuggerModel 中](https://link.zhihu.com/?target=https%3A//source.chromium.org/chromium/chromium/src/%2B/main%3Aout/Debug/gen/third_party/devtools-frontend/src/front_end/core/sdk/DebuggerModel.js%3Bl%3D280%3Bdrc%3Df09c12c84b39d13189a7039a05253ca3766d4751%3Bbpv%3D0%3Bbpt%3D0) ：
...
在 DevTools 中，停止代码执行到断点的核心实现是通过使用 [V8 JS 引擎](https://zhida.zhihu.com/search?content_id=236397384&content_type=Article&match_order=1&q=V8+JS+%E5%BC%95%E6%93%8E&zhida_source=entity) 中的断点机制来实现的。当 chromium 执行到一个断点时，V8 会暂停 JS 代码的执行，并将控制权转交给 Devtools。这时候，Devtools 可以执行上述提到的断点调试的各种操作。
...
![[../../_resources/聊聊网页断点调试及其扩展/7ad06fb2e0b2a71615aa36d46c540943_MD5.jpg]]

通过 Devtools Agent，负责接收 Devtools 通信信息，并将断点信息移交给 V8，然后由 V8 来对代码进行停止操作。

V8 里面的逻辑我只能看一个大概，整体逻辑如下：

![[../../_resources/聊聊网页断点调试及其扩展/d788f4161131623d3b630ee82776539d_MD5.jpg]]
...
![[../../_resources/聊聊网页断点调试及其扩展/c689e19bd725ed3dff251e6ee916798f_MD5.webp]]

## Vscode Web 代码断点调试原理

在 Vscode 中调试代码，能让开发者专注于代码本身，一边开发运行一边断点调试查看变量信息，并减少一些脏代码的开发。如下图所示，可以看到，似乎是将浏览器的 Debugger 的逻辑照搬到了 Vscode 中。

![[../../_resources/聊聊网页断点调试及其扩展/3561f7ceeaed5e05f03cc83db48c38d6_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/bf2b8553668378b09efc32ffe1849619_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/ac2c24587fce06a369405b92c5bf1af3_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/38eee574958920fb4743489962687514_MD5.webp]]

![[../../_resources/聊聊网页断点调试及其扩展/322a3d37468d8f103a6848cb0525f1a8_MD5.webp]]

1. 当在 Vscode 调试面板操作 `StepInto` 按钮时，Vscode 代码会走到下一步，同时 chrome 调试也会走到下一步。
2. 当在 Chrome Devtools 中操作 `StepInto` 按钮时，Chrome Devtools 代码也会走到下一步，同时 Vscode 中代码也会跳转到下一步。

通过上面 3 种现象可以看出，Vscode Webpage Devtools 关系如下：

![[../../_resources/聊聊网页断点调试及其扩展/c5f200762da8758eca4751c42181ab46_MD5.jpg]]
...
[Extension 启动 Chrome 的逻辑在 companionBrowserLaunch 中](https://link.zhihu.com/?target=https%3A//github.com/microsoft/vscode-js-debug/blob/main/src/ui/companionBrowserLaunch.ts%23L50)
...
![[../../_resources/聊聊网页断点调试及其扩展/e001c4259a33ede9433c0fa1f17b4258_MD5.webp]]

![[../../_resources/聊聊网页断点调试及其扩展/dafdde46700f5e357a7a846642174478_MD5.webp]]
...
[相关 DAP 格式可以在 debug-adapter-protocol 查阅](https://link.zhihu.com/?target=https%3A//microsoft.github.io/debug-adapter-protocol/overview)

如果要在 Vscode 中查看实时的 DAP 和 CDP 消息，可以通过如下操作：

![[../../_resources/聊聊网页断点调试及其扩展/a6edeb736838e1b85e3693159e59a4c0_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/8d9b3df3cdebbe0d1146010688e1369c_MD5.webp]]

当我在源码的 main.ts 中设置断点时，可以看到 Request 中的 url 为 `host:port/src/main.ts` ，即实际传给 WebPage 的断点文件为编译后的文件。

![[../../_resources/聊聊网页断点调试及其扩展/faae9b0701201ff58b232010a75fba0a_MD5.webp]]

![[../../_resources/聊聊网页断点调试及其扩展/8e9212031baac87422e1ca003fbb5e67_MD5.webp]]

JS Debug Extension 亦是如此。

当在 Vscode 的源码中增加了一个断点，JS Debug Extension 会根据 sourceMap 将源代码路径映射到编译后的代码路径中，并将这个信息发送给浏览器。

![[../../_resources/聊聊网页断点调试及其扩展/48a67027f5b99f3566f6c9d9578f7113_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/bd3549d13de1ec0d00b7f2639974bc7a_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/4292dec779e5d4bbf1fd98791dc6904b_MD5.webp]]

打断点，刷新小程序，即可跳转到断点位置。此时可以看到对应的 CDP 消息中的 Request。

![[../../_resources/聊聊网页断点调试及其扩展/60966558376946a6e69ec775f7a0922a_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/c1a1b6bdf3ace8d804254daff870365a_MD5.webp]]
...
![[../../_resources/聊聊网页断点调试及其扩展/f14cb93edbb037a9eb84cb1a68ad260f_MD5.jpg]]
...
\[2\] [Debugging over the V8 Inspector Protocol](https://link.zhihu.com/?target=https%3A//v8.dev/docs/inspector)

\[3\] [Adapter Debug Protocol](https://link.zhihu.com/?target=https%3A//microsoft.github.io/debug-adapter-protocol/)

\[4\] [SourceMap](https://zhuanlan.zhihu.com/p/615279891)

**关注「字节前端 ByteFE」公众号，追更不迷路！**

发布于 2023-11-16 16:45・北京 [前端开发](https://www.zhihu.com/topic/19550901)
