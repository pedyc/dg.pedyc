...
> [!quote] 一言
>  前尘种种，似烟似幻，惟有此人教我深感不负大好春光。 —— 《魔道祖师》 · 佚名

## ☁️行云（闪念笔记）

- [[在Linux中可以通过别名让claude切换不同的模型]]
- TODO
...
WHERE file.mtime >= date("2026-04-25") AND file.mtime < date("2026-04-25") + dur(1 day) OR file.ctime = date("2026-04-25")
