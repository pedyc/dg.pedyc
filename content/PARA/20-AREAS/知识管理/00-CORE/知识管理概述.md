...
![[draw_PKM_Processes.excalidraw.svg]]
...
| **知识管理领域** | **PARA 分类建议**   | 示例内容          |
| ---------- | --------------- | ------------- |
| 知识获取       | Resources（资源库）  | 优质书单、课程合集     |
| 知识组织/内化    | Areas（领域）       | 0801- 知识组织方法  |
| 知识生产       | Projects（项目）    | 撰写某主题文章       |
| 知识共享       | Projects/Areas  | 团队知识库搭建项目     |
| 工具与技术      | Resources/Areas | Obsidian 插件清单 |
| 归档内容       | Archives（归档）    | 过时的学习笔记       |
