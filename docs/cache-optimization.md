...
const fetchContentCache = new OptimizedCacheManager<Element[]>(
  searchCacheConfig.capacity,
  searchCacheConfig.ttl,
)
```
...
const linkValidityCache = new OptimizedCacheManager<boolean>(
  linkValidityCacheConfig.capacity,
  linkValidityCacheConfig.ttl,
)
```
